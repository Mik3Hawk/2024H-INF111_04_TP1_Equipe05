...
public abstract class Message implements Comparable<Message> {
    ...
    /**
     * Méthodes pour représenter un message sous forme de string
     *
     * @return le message avec sont type puis ses parametres
     */
    @Override
    public String toString() {
        ...
        if (this instanceof Commande) {
            if (((Commande) this).getCommande() == eCommande.DEPLACER_ROVER) {
                return "Commande" + s + ", " + ((Commande) this).getCommande() + ((Commande) this).getVect();
            } else {
                return "Commande" + s + ", " + ((Commande) this).getCommande();
            }
        }
